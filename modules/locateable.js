...
When the location hash changes to be equal to a `locateable`'s id it may be 
styled with the  `:target` selector, and links that reference that locateable 
via their `href` attribute are given the class `"on"`.
